...
<head>
    ...
    <title>MONOTRIBUTO.NET | Inscripción de Responsable Inscripto</title>
    ...
    <section class="container mx-auto mt-10 h-full">
        ...
        <div class="flex items-center justify-center p-12 bg-slate-200">
            ...
            <div class="mx-auto w-full  ">
                <h1 class="flex justify-center items-center text-3xl font-bold mb-5">Inscripción a Responsable Inscripto</h1>
                <br>
                <p class="mb-5 font-light italic text-gray-500">El trámite de alta como responsable inscripto, incluye una entrevista con un contador público que explicará con lujo de detalle todas las implicancias. La entrevista será máximo de 45 minutos, pudiendo ser de manera presencial o virtual (Google meet / Zoom).</p>
                <br>
                <form method="post" action="mailResponsableInscripto.php" enctype="multipart/form-data">
                    ...
                    <div class="mb-5">
                        ...
                        <select id="ingresosBrutos[]" name="ingresosBrutos[]" class="ingresosBrutos w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280]
                                 outline-none focus:border-[#6A64F1] focus:shadow-md"
                            autocomplete="off"
                ...
                <div
                    ...
                    <article
                        ...
                        <div class="relative mb-4 rounded-2xl">
                            ...
                            <p>CTA: 4019611-8 322-1</p>
                            <p>CBU: 00703220-30004019611818</p>
                            <p>ALIAS: Marker.Federico.Gali</p>
                            <p>CUIT/CUIL: 20-40536915-0</p>
                        </div>
                        </a>
                    </article>
                    ...
                    <article
                        ...
                        <div class="relative mb-4 rounded-2xl">
                            ...
                            <p>CVU: 0000003100089782170480</p>
                            <p>ALIAS: signoretta.mp</p>
                            <p>CUIT/CUIL: 20388303124</p>
                            <p>Mercado Pago</p>
                        </div>
                        </a>
                    </article>
...
<script>
    ...
    const igInput = document.getElementById("ingresosBrutos");
